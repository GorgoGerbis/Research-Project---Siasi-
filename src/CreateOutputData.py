...
REQUESTS_FILE = os.path.join(outputFolder, "REQUESTS_OUTPUT_TEST_NEW.csv")
REQUESTS_FILE_WITH = os.path.join(outputFolder, "REQUESTS_OUTPUT_TEST_WITH_FAULT_NEW.csv")
